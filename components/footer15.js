        ...
        <div className="footer15-max-width thq-section-max-width">
                  ...
                  <div className="footer15-form">
                    ...
                    <button className="thq-button-outline">
                      <span className="thq-body-small">
                        {props.action1 ?? (
                          <Fragment>
                            <span className="footer15-text6">Subscribe</span>
                          </Fragment>
                        )}
                      </span>
                    </button>
          ...
          <div className="footer15-credits1">
            <div className="footer15-row">
              <div className="footer15-credits2">
                <span className="thq-body-small">
                  {props.privacyLink ?? (
                    <Fragment>
                      <span className="footer15-text3">Privacy Policy</span>
                    </Fragment>
                  )}
                </span>
                <span className="thq-body-small">
                ...
                <span className="thq-body-small">
                  {props.cookiesLink ?? (
                    <Fragment>
                      <span className="footer15-text4">Cookies Settings</span>
                    </Fragment>
                  )}
                </span>
              </div>
            ...
            <span className="footer15-content3 thq-body-small">
              {props.copyright ?? (
                <Fragment>
                  <span className="footer15-text1">© 2024 TeleportHQ</span>
                </Fragment>
              )}
            </span>
          </div>
